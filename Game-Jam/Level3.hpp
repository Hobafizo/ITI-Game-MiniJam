...
static LevelData Level3Data = {
    ...
    {
        { sf::Vector2f(960.f, 700.f),  sf::Vector2f(200.f, 20.f), 0.f },
        { sf::Vector2f(960.f, 200.f), sf::Vector2f(100.f, 20.f), 0.f },
        { sf::Vector2f(910.f, 100.f), sf::Vector2f(20.f, 100.f), 0.f },
        { sf::Vector2f(100.f, 300.f), sf::Vector2f(20.f, 100.f), 0.f },
    ...
    {
        { sf::Vector2f(1300.f, 700.f), 20.5f },
        { sf::Vector2f(20.f, 900.f), 20.5f },
    },
